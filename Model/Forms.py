...
class SignUpForm2(Form):
    ...
    qns2 = SelectField('Second Question', [validators.DataRequired()], choices=[('', 'Select')], default='')
    ans2 = PasswordField('Answer The Question', [validators.DataRequired()])
    qns3 = SelectField('Third Question', [validators.DataRequired()], choices=[('', 'Select')], default='')
